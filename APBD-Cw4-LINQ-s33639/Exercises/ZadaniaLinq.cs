...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        ...
        if (przedmiot == null)
        {
            return new[] { "Brak przedmiotu w kategorii Analytics" };
        }

        return new[]
        {
            $"{przedmiot.Nazwa} - start: {przedmiot.DataStartu:d}"
        };
    }
    ...
    public IEnumerable<string> Zadanie05_CzyIstniejeNieaktywneZapisanie()
    {
        ...
        return new[]
        {
            $"Czy istnieje nieaktywny zapis: {istnieje}"
        };
    }
    ...
    public IEnumerable<string> Zadanie06_CzyWszyscyProwadzacyMajaKatedre()
    {
        ...
        return new[]
        {
            $"Czy wszyscy prowadzący mają katedrę: {wszyscy}"
        };
    }
    ...
    public IEnumerable<string> Zadanie07_LiczbaAktywnychZapisow()
    {
        ...
        return new[]
        {
            $"Liczba aktywnych zapisów: {liczba}"
        };
    }
    ...
    public IEnumerable<string> Zadanie09_TrzyNajnowszeZapisy()
    {
        return DaneUczelni.Zapisy
            ...
            .Take(3)
            .Select(z => $"{z.DataZapisu:d} | StudentId: {z.StudentId} | PrzedmiotId: {z.PrzedmiotId}");
    }
    ...
    public IEnumerable<string> Zadanie11_PolaczStudentowIZapisy()
    {
        return DaneUczelni.Studenci
            .Join(
                ...
                s => s.Id,
                z => z.StudentId,
                (s, z) => $"{s.Imie} {s.Nazwisko} - zapis: {z.DataZapisu:d}"
            );
    }
    ...
    public IEnumerable<string> Zadanie15_ProwadzacyILiczbaPrzedmiotow()
    {
        return DaneUczelni.Prowadzacy
            .GroupJoin(
                ...
                p => p.ProwadzacyId,
                (pr, przedmioty) =>
                    $"{pr.Imie} {pr.Nazwisko} - przedmioty: {przedmioty.Count()}"
            );
    }
    ...
    public IEnumerable<string> Wyzwanie01_StudenciZWiecejNizJednymAktywnymPrzedmiotem()
    {
        return DaneUczelni.Zapisy
            ...
            .Where(g => g.Count() > 1)
            .Select(g => $"{g.Key.Imie} {g.Key.Nazwisko} - aktywne: {g.Count()}");
    }
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        return DaneUczelni.Przedmioty
            ...
            .Where(p => DaneUczelni.Zapisy
                .Where(z => z.PrzedmiotId == p.Id)
                .All(z => z.OcenaKoncowa == null))
            .Select(p => p.Nazwa);
    }
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        return DaneUczelni.Prowadzacy
            ...
            .GroupBy(x => new { x.Imie, x.Nazwisko })
            .Select(g => $"{g.Key.Imie} {g.Key.Nazwisko} - średnia: {g.Average(x => x.OcenaKoncowa):F2}");
    }
